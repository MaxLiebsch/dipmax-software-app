            ...
            <Card>
              ...
              <CardContent className="grid gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-medium">{t("contactInformation.phone")}</p>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-medium">{t("contactInformation.email")}</p>
                    <p className="text-sm text-muted-foreground">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-medium">{t("contactInformation.address")}</p>
                    <p className="text-sm text-muted-foreground">
            ...
            <Card>
              ...
              <CardContent className="grid gap-2">
                <div className="flex justify-between">
                  ...
                  <p className="text-sm">{t("contactInformation.mon-fri-hours")}</p>
                </div>
                <div className="flex justify-between">
